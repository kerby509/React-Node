                ...
                <h1>Condomino Residencial</h1>
                 ...
                 Habitacional São Bartolomeu. A Fazenda Taboquinha, de onde se originam as terras de nosso
                  Condomínio, tem documentação centenária, remontando ao início do século XIX, quando as  transações
                   imobiliárias eram anotadas pelas secretarias das igrejas católicas, por meio de  “registros paroquiais”.</p> 
                    </div>
                    <div>
                        <p className="par"> Nosso Condomínio resultante do parcelamento da fazenda original,  denominado “Quinhão 11”, também conhecido por “Serrinha”, com a área de 218 hectares. A Fazenda
                     Taboquinha, a partir de 1955, pertenceu a Pedro Ferreira Alves e Dona Romualda,  ocupando uma área de 1700 alqueires, abrangendo
                      ...
                      Taboca e ao Rio São Bartolomeu. Durante o processo de instalação da capital Federal, uma parte 
